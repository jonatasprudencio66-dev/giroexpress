...
const LOGO = "https://customer-assets-7cd3h4nn.emergentagent.net/job_delivery-hub-1328/artifacts/cbmomf8_image.png";
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-orange-600 via-orange-500 to-amber-500 items-center justify-center p-10 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6 max-w-md">
          <img
            src={LOGO}
            alt="# GiroExpress"
            className="mx-auto w-56 h-auto bg-white/95 rounded-3xl p-4 shadow-2xl"
          />
        ...
        <div className="w-full max-w-md space-y-6">
          <div className="md:hidden text-center">
            <img
              src={LOGO}
              alt="# GiroExpress"
              className="mx-auto w-40 bg-white rounded-2xl p-2"
            />
          </div>
